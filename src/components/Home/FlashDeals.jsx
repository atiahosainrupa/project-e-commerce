  ...
  return (
    <section className='pb-[50px]'>
      <div className="container">
        ...
        <ProductCard head= "Women fashion dress set" img="flash-deals-1.png" price="৳10500" discount="-25% OFF"/>
        <ProductCard head= "Women fashion dress set" img="flash-deals-2.png" price="৳1000" discount="-25% OFF"/>
        <ProductCard head= "Women fashion dress set" img="flash-deals-3.png" price="৳৳5000" discount="-25% OFF"/>
